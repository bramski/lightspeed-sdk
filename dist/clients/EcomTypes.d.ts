...
export declare type ShipmentData = {
    method: string;
    shipment_id: number;
...
export declare type ResourceLink = {
    resource: {
        id: number;
        url: string;
        link: string;
...
export declare type PaymentStatus = 'not_paid' | 'partially_paid' | 'paid' | 'cancelled';
