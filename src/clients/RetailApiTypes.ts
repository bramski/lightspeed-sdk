...
export type CustomerParams = 'firstName' | 'lastName' | 'dob' | 'archived' | 'title' |
  'company' | 'companyRegistrationNumber' | 'vatNumber' | 'createTime' | 'timeStamp' | 'creditAccountID' |
  'customerTypeID' | 'discountID' | 'taxCategoryID';
...
export type PostCustomer = Optional<Customer, 'customerID' | 'createTime' | 'timeStamp' | 'archived'>;
...
export type PostSale = Optional<Sale,
  'saleID' | 'createTime' | 'updateTime' | 'timeStamp' | 'archived' | 'isTaxInclusive' | 'tax1Rate' |
  'MetaData' | 'calcAvgCost' | 'calcDiscount' | 'calcFIFOCost' | 'calcNonTaxable' | 'calcPayments' |
  'calcSubtotal' | 'calcTax1' | 'calcTax2' | 'calcTaxable' | 'calcTips' | 'calcTotal' | 'change' |
  'discountID' | 'displayableSubtotal' | 'displayableTotal' | 'quoteID' | 'receiptPreference' | 'shipToID' |
  'tax2Rate' | 'taxTotal' | 'ticketNumber' | 'tipEmployeeID' | 'tipEnabled' | 'total' | 'totalDue' | 'discountPercent' |
  'voided' | 'completeTime' | 'referenceNumber' | 'referenceNumberSource'>;
